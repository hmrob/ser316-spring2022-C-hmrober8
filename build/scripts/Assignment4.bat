...
set CLASSPATH=%APP_HOME%\lib\Assignment4.jar;%APP_HOME%\lib\cls;%APP_HOME%\lib\junit-4.12.jar;%APP_HOME%\lib\guava-16.0.1.jar;%APP_HOME%\lib\hamcrest-core-1.3.jar
